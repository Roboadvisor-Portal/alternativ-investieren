# Launch-Artikel als portables JSON-Datenmodell (Mongo als Source-of-Truth).
# Wird beim Startup idempotent nach MongoDB migriert (nur wenn Slug fehlt).

SEED_ARTICLES = [
    {
        "slug": "crowdlending-vs-klassisches-sparen",
        "title": "Crowdlending vs. klassisches Sparen: Chancen und Risiken im Vergleich",
        "excerpt": "Höhere Zinschancen, aber keine Einlagensicherung: Was Crowdlending vom Sparbuch unterscheidet – mit aktuellen Marktzahlen und klarer Risiko-Einordnung.",
        "metaTitle": "Crowdlending vs. klassisches Sparen: Chancen und Risiken im Vergleich",
        "metaDescription": "Crowdlending bietet höhere Zinschancen als das Sparbuch, verzichtet aber auf die Einlagensicherung. Marktzahlen, Chancen, Risiken und für wen es sich eignet.",
    ...
    },
    {
        ...
        "excerpt": "Zwei reale Insolvenzfälle, der typische Verfahrensablauf und was Anleger konkret tun sollten, wenn eine Plattform oder ein Emittent pleitegeht.",
        "metaTitle": "Plattform-Insolvenz: Was passiert mit meinem investierten Geld?",
        "metaDescription": "Bei einer Plattform- oder Emittenten-Insolvenz stehen Anleger oft am Ende der Gläubigerkette. Ablauf, zwei reale Fälle und was Anleger konkret tun sollten.",
        "category": "crowdlending",
    ...
    },
    {
        ...
        "excerpt": "Was ein Nachrangdarlehen ist, warum Unternehmen es nutzen und weshalb Anleger im Insolvenzfall am Ende der Kette stehen – mit aktuellem Praxisbeispiel.",
        "metaTitle": "Nachrangdarlehen einfach erklärt: Diese Risiken sollten Sie kennen",
        "metaDescription": "Ein Nachrangdarlehen bedient Anleger im Insolvenzfall zuletzt. Was der Rangrücktritt bedeutet, warum Unternehmen das Modell nutzen und welche Risiken bestehen.",
